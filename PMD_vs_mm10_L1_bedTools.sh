...
# create your working directory for your bedtools environment
    mkdir bed_tools_PMDvsL1             # working directory should be outside the anaconda3 directory
    cd bed_tools_PMDvsL1                # go to your bedtools working directory
...
# PMD vs mm10 Enhancer files to create inside_PMD_mm10_Enhancers
    bedtools intersect -a L1_mm10.bed -b PMD_mm10_modified.bed > inside_PMD_L1_mm10_intersect.bed -wa

# sort the file based on the first column
    sort -k1,1 inside_PMD_L1_mm10_intersect.bed > inside_PMD_mm10_L1.bed

#########################################################################################################################

# PMD vs mm10 Enhancer files to create outside_PMD_mm10_Enhancers
    bedtools intersect -a PMD_mm10_modified.bed -b L1_mm10.bed > outside_PMD_mm10_L1_intersect.bed -wa

# remove duplicate rows from a file in Unix, you can use the uniq command
    sort outside_PMD_mm10_L1_intersect.bed | uniq > outside_PMD_mm10_L1_no_duplicates_not_sorted.bed

# sort the file based on the first column
    sort -k1,1 outside_PMD_mm10_L1_no_duplicates_not_sorted.bed > outside_PMD_mm10_L1_no_duplicates_sorted.bed

# Reporting the absence of any overlapping features
    bedtools intersect -a L1_mm10.bed -b outside_PMD_mm10_L1_no_duplicates_sorted.bed > outside_PMD_mm10_L1.bed -v
