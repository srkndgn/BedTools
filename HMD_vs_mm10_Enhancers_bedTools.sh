...
# create your working directory for your bedtools environment
    mkdir bed_tools_HMDvsEnhancers_mm10             # working directory should be outside the anaconda3 directory
    cd bed_tools_HMDvsEnhancers_mm10                # go to your bedtools working directory
...
# HMD vs mm10 Enhancer files to create inside_HMD_mm10_Enhancers
    bedtools intersect -a E4_coord_enhancers.bed -b HMD_mm10_modified.bed > inside_HMD_mm10_Enhancers_intersect.bed -wa

# remove duplicate rows from a file in Unix, you can use the uniq command
    sort inside_HMD_mm10_Enhancers_intersect.bed | uniq > inside_HMD_mm10_Enhancers_no_duplicates_not_sorted.bed


# sort the file based on the first column
    sort -k1,1 inside_HMD_mm10_Enhancers_no_duplicates_not_sorted.bed > inside_HMD_mm10_Enhancers.bed

#########################################################################################################################

# HMD vs mm10 Enhancer files to create outside_HMD_mm10_Enhancers
    bedtools intersect -a HMD_mm10_modified.bed -b E4_coord_enhancers.bed > outside_HMD_mm10_Enhancers_intersect.bed -wa

# remove duplicate rows from a file in Unix, you can use the uniq command
    sort outside_HMD_mm10_Enhancers_intersect.bed | uniq > outside_HMD_mm10_Enhancers_no_duplicates_not_sorted.bed

# sort the file based on the first column
    sort -k1,1 outside_HMD_mm10_Enhancers_no_duplicates_not_sorted.bed > outside_HMD_mm10_Enhancers_no_duplicates_sorted.bed

# Reporting the absence of any overlapping features
    bedtools intersect -a E4_coord_enhancers.bed -b outside_HMD_mm10_Enhancers_no_duplicates_sorted.bed > outside_HMD_mm10_Enhancers.bed -v
